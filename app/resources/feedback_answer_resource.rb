...
class FeedbackAnswerResource < ApplicationResource
  ...
  belongs_to :feedback_question,
    resource: FeedbackQuestionResource,
    foreign_key: :feedback_question_id,
    scope: -> { FeedbackQuestion.all }
  belongs_to :feedback_response,
    resource: FeedbackResponseResource,
    foreign_key: :feedback_response_id,
    scope: -> { FeedbackResponse.all }
